...
** ===========================================================================
** File: GreyBitType.h
** Description: GreyBit font library - header for internal and external use
** Copyright (c) 2010
...
** MM-DD-YYYY-- --------------- --------------------------------
** 11/19/2010	jiaoyuhai		8to1, param changes
** 11/04/2010	jiaoyuhai		Horioff and width
** 05/31/2010	jiaoyuhai       Init
** ===========================================================================
*/
...
// Bitmap
extern GB_Bitmap    GreyBitType_Bitmap_New(GBHANDLE library, GB_INT16 nWidth,
                                           GB_INT16 nHeight,GB_INT16 bitcount,
                                           GB_BYTE * pInitBuf);
extern void         GreyBitType_Bitmap_Done(GBHANDLE library,
                                            GB_Bitmap bitmap);

// Outline
extern GB_Outline   GreyBitType_Outline_New(GBHANDLE library,
                                            GB_INT16 n_contours,
                                            GB_INT16 n_points);
extern GB_Outline   GreyBitType_Outline_Clone(GBHANDLE library,
                                              GB_Outline source);
extern int          GreyBitType_Outline_Remove(GB_Outline outline,
                                               GB_INT16 idx);
extern GB_INT32     GreyBitType_Outline_GetSize(GB_Outline outline);
extern GB_INT32     GreyBitType_Outline_GetSizeEx(GB_INT16 n_contours,
                                                  GB_INT16 n_points);
extern int          GreyBitType_Outline_Transform(GB_Outline outline,
                                                  GB_Outline source,
                                                  GB_INT16 tosize,
                                                  GB_INT16 fromsize);
extern void         GreyBitType_Outline_Done(GBHANDLE library,
                                             GB_Outline outline);

#ifdef ENABLE_ENCODER
// Creator
extern GBHANDLE     GreyBitType_Creator_New(GBHANDLE library,
                                            const GB_CHAR * filepathname);
extern int          GreyBitType_Creator_SetParam(GBHANDLE creator,
                                                 GB_Param nParam,
                                                 GB_UINT32 dwParam);
extern int          GreyBitType_Creator_DelChar(GBHANDLE creator,
                                                GB_UINT32 nCode);
extern int          GreyBitType_Creator_SaveChar(GBHANDLE creator,
                                                 GB_UINT32 nCode,
                                                 GB_Data pData);
...
// Loader
extern GBHANDLE     GreyBitType_Loader_New(GBHANDLE library,
                                           const GB_CHAR* filepathname);
extern GBHANDLE     GreyBitType_Loader_New_Stream(GBHANDLE library,
                                                  GBHANDLE stream,
                                                  GB_INT32 size);
extern GBHANDLE     GreyBitType_Loader_New_Memory(GBHANDLE library,
                                                  void * pBuf,
                                                  GB_INT32 nBufSize);
extern GB_INT32     GreyBitType_Loader_GetCount(GBHANDLE loader);
extern GB_INT32     GreyBitType_Loader_GetHeight(GBHANDLE loader);
extern int          GreyBitType_Loader_SetParam(GBHANDLE loader,
                                                GB_Param nParam,
                                                GB_UINT32 dwParam);
extern GB_BOOL      GreyBitType_Loader_IsExist(GBHANDLE loader,
                                               GB_UINT32 nCode);
extern void         GreyBitType_Loader_Done(GBHANDLE loader);

// Layout
extern GBHANDLE     GreyBitType_Layout_New(GBHANDLE loader,
                                           GB_INT16 nSize,
                                           GB_INT16 nBitCount,
                                           GB_BOOL bBold,
                                           GB_BOOL bItalic);
extern GB_INT32     GreyBitType_Layout_GetWidth(GBHANDLE layout,
                                                GB_UINT32 nCode);
extern int          GreyBitType_Layout_LoadChar(GBHANDLE layout,
                                                GB_UINT32 nCode,
                                                   GB_Bitmap * pBmp);
